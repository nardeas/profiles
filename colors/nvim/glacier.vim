...
let s:style = get(g:, 'glaciercolor', 'light')
...
let s:palette = {}
let s:palette.bg        = {'light': "#FFFFFF"}
let s:palette.comment   = {'light': "#C9C9C9"}
let s:palette.markup    = {'light': "#F01DE9"}
let s:palette.constant  = {'light': "#F01DE9"}
let s:palette.operator  = {'light': "#FF2483"}
let s:palette.tag       = {'light': "#36A3D9"}
let s:palette.regexp    = {'light': "#4CBF99"}
let s:palette.string	= {'light': "#86B2F0"}
let s:palette.function  = {'light': "#000000"}
let s:palette.special   = {'light': "#666666"}
let s:palette.keyword   = {'light': "#666666"}
let s:palette.error     = {'light': "#FF3333"}
let s:palette.accent    = {'light': "#1f1f1f"}
let s:palette.panel     = {'light': "#F8F8F8"}
let s:palette.guide     = {'light': "#888888"}
let s:palette.line      = {'light': "#F3F3F3"}
let s:palette.selection = {'light': "#F0F0F0"}
let s:palette.search	= {'light': "#007cad"}
let s:palette.notice	= {'light': "#1CEB9B"}
let s:palette.fg        = {'light': "#5C6773"}
let s:palette.fg_idle   = {'light': "#828C99"}
...
exe "hi! Search"        .s:fg_bg		  .s:bg_search      .s:fmt_none
...
exe "hi! WildMenu"      .s:fg_bg          .s:bg_guide       .s:fmt_none
...
exe "hi! Keyword"         .s:fg_keyword   .s:bg_none        .s:fmt_bold
"   Exception"
...
" GitGutter
" ---------
exe "hi! GitGutterAdd"          .s:fg_notice     .s:bg_none        .s:fmt_none
